        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CoverUrl = table.Column<string>(type: "TEXT", maxLength: 300, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    FromShopId = table.Column<int>(type: "INTEGER", nullable: false),
                    ToShopId = table.Column<int>(type: "INTEGER", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Transfers_Shops_FromShopId",
                        column: x => x.FromShopId,
                        principalTable: "Shops",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Transfers_Shops_ToShopId",
                        column: x => x.ToShopId,
                        principalTable: "Shops",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    ProductId = table.Column<int>(type: "INTEGER", nullable: false),
                    FromShelfId = table.Column<int>(type: "INTEGER", nullable: true),
                    ToShelfId = table.Column<int>(type: "INTEGER", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductTransactions_Shelves_FromShelfId",
                        column: x => x.FromShelfId,
                        principalTable: "Shelves",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ProductTransactions_Shelves_ToShelfId",
                        column: x => x.ToShelfId,
                        principalTable: "Shelves",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ProductTransactions_Transfers_TransferId",
                        column: x => x.TransferId,
                        principalTable: "Transfers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductTransactions_FromShelfId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductTransactions_ToShelfId",
                table: "ProductTransactions",
                column: "ToShelfId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductTransactions_TransferId",
                table: "ProductTransactions",
                column: "TransferId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Transfers_FromShopId",
                table: "Transfers",
                column: "FromShopId");

            migrationBuilder.CreateIndex(
                name: "IX_Transfers_ToShopId",
                table: "Transfers",
                column: "ToShopId");
